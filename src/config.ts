  ...
  projects: [
    {
      ...
      shortSolution: "A GPT-4o Vision dashboard that turns receipt photos or pasted text into structured transactions with instant tax and spend insights.",
      outcome: "18 structured transactions and 172 line items from 20 receipts — exportable to JSON/CSV.",
    ...
    },
    {
      ...
      shortSolution: "A local RAG eval pipeline on Apple's FY2024 10-K measuring honest refusals vs. confident hallucinations.",
      outcome: "Caught a confident hallucination on Apple's 10-K and exposed a DeepEval metric bug — my fix now ships in DeepEval (PR #2743 merged).",
    ...
    },
    {
      ...
      status: "Open Source",
      category: "System Design",
      shortProblem: "Prompt engineering is manual guesswork — no systematic way to know if a change actually helped.",
      shortSolution: "An edit → evaluate → keep/reject loop that optimizes a prompt against a scoring function.",
      outcome: "Took a prompt from 0.10 to 0.80 in 10 rounds — 3 mutations rejected, no regression.",
    ...
    },
    {
      ...
      status: "Live",
      category: "Shipped Product",
      shortProblem: "We screenshot everything, then never find it — filenames carry zero searchable context.",
      shortSolution: "A Gemini-powered organizer that categorizes screenshots and lets you search them by their content.",
      outcome: "Turns a loose screenshot dump into a gallery you search by meaning — \"AWS invoice,\" \"sushi menu\" — not filenames.",
    ...
    },
    {
      ...
      status: "Live",
      category: "System Design",
      shortProblem: "Food labels hide sugar under dozens of names, and most scanners won't tell you how confident they are.",
      shortSolution: "A GPT-4o ingredient scanner with a built-in eval dashboard that over-warns by design, so it never misses hidden sugar.",
      outcome: "Eval-first: 0 false negatives and 87% trigger-match, with a live /eval dashboard.",
    ...
    },
    {
      ...
      status: "Open Source",
      category: "System Design",
      shortProblem: "Job search doesn't scale: ~20–30 min per application, and auto-apply bots torch your reputation.",
      shortSolution: "A local CLI that finds 250+ real jobs hourly and auto-applies only to roles that pass 6 mandatory quality gates.",
      outcome: "Applies at scale, safely — every application must clear a fit, ATS, and no-fabrication gate first.",
